...
def main():
    ...
    total_time = num_packets * num_threads  # Total time is based on number of packets and threads
    ...
    for _ in range(num_threads):
        ...
        if random.choice([True, False]):
            threading.Thread(target=send_tcp_packets, args=(target_ip, target_port, packet_size, num_packets, interval)).start()
        else:
            threading.Thread(target=send_udp_packets, args=(target_ip, target_port, packet_size, num_packets, interval)).start()
